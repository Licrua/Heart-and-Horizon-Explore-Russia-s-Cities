  ...
  return (
    ...
    >
      ...
      <div className={styles.font}>
        <p>
          <strong>
            Мы рады приветствовать вас в мире, где величественные горы
            встречаются с бескрайними равнинами, где каждый город хранит свои
            уникальные традиции и историю. Здесь вы сможете узнать больше о
            великой стране, которая объединяет в себе удивительное разнообразие
            культур, природных богатств и удивительных людей.
          </strong>
        </p>
        <p>
