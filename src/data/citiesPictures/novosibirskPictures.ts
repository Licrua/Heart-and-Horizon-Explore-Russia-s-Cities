import { NovosibirskPicturesType } from '@data/cityImagesMap';
...
const novosibirskImagesMap: NovosibirskPicturesType = {
  akademgorodok,
  krasnyProspekt,
  novosibirskStateUniversity,
  novosibirskZoo,
  operaAndBalletTheatre,
};
export default novosibirskImagesMap;
